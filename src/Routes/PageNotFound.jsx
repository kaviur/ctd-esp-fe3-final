...
<div class="flex items-center justify-center w-full  ">
    <div class="flex flex-col text-gray-700 sm:flex-row lg:space-x-16 lg:space-x-reverse">
    <div class="order-1 max-w-xs px-2 text-sm md:text-base lg:px-0">
        <header class="mb-6">
        ...
        No te preocupes a veces ocurren errores.
        </p>
